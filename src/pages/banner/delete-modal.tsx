...
import { CloseIcon, EditIcon, SettingIcon, TrashIcon } from "../../assets/icons";
...
const DeleteModal = ({ setToggleData, banner }: Props) => {
    ...
    const onSubmit: SubmitHandler<IBanner> = async (data) => {
        ...
        try {
            const { status: httpStatus, data: response } = await bannerApi.DeleteBanner(data);
                        ...
                        <form className="p-4 md:p-5" onSubmit={handleSubmit(onSubmit)}>
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                <div className="col-span-2">
                                    ...
                                    <input readOnly id="name" placeholder="banner name..." {...register("name")} className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" />
                                ...
                                <div className="col-span-2">
                                    ...
                                    <input readOnly id="code" placeholder="banner code..." {...register("code")} className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" />
