...
const CreateModal = ({ setToggleData }: any) => {
    ...
    const onSubmit: SubmitHandler<IBanner> = async (data) => {
        ...
        try {
            const { status: httpStatus, data: response } = await bannerApi.AddBanner(data);
        ...
        <div>
            <div className="flex justify-end">
                <button
                    ...
                    className="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    type="button"
