  ...
  return (
    <div>
      ...
      <div
        ...
        tabIndex={-1}
        aria-hidden="true"
        className={`overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-[rgba(0,0,0,0.4)] ${
          isShow ? "flex" : "hidden"
        }`}
      >
        <div className="relative p-4 w-full max-w-[600px] max-h-full">
          {/* Modal content */}
      ...
      <ul>
        <li className={activedTab === 0 ? "block" : "hidden"}>
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
            <form className="max-w-[90%] mx-auto my-8">
